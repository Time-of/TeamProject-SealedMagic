...
public class PlayerLongAttack : MonoBehaviour
{
    ...
    void GroudAttackShoot()
    {
        ...
        foreach (Collider2D i in hit)
        {
            ...
            Instantiate(impactEffect[4], Vector3.up * 1.5f + i.transform.position, Quaternion.identity);
            binCk = true;
    ...
    void ThunderShoot()
    {
        ...
        foreach (Collider2D i in Thit)
        {
            ...
            Instantiate(impactEffect[6], Vector3.up * 2.5f + i.transform.position, Quaternion.identity);
            binCk = true;
